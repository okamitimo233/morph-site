    ...
    const ctx = gsap.context(() => {
      ...
      tl.from('.hero-title', {
        ...
        .from(
          ...
          '-=0.4'
        ) // Start 0.4s before previous ends
        .from(
          '.hero-button',
          {
            y: 20,
...
All animation patterns in this guide are available as copy-paste templates:

| Example            | File                                                   | Use Case              |
| ------------------ | ------------------------------------------------------ | --------------------- |
| Entrance animation | `examples/skills/gsap/entrance-animation.tsx.template` | Fade-in on mount      |
| Staggered list     | `examples/skills/gsap/stagger-list.tsx.template`       | Animated list items   |
| Timeline hero      | `examples/skills/gsap/timeline-hero.tsx.template`      | Sequenced animations  |
| Scroll reveal      | `examples/skills/gsap/scroll-reveal.tsx.template`      | ScrollTrigger effects |
| Hover button       | `examples/skills/gsap/hover-button.tsx.template`       | Interactive buttons   |
| Mouse follow       | `examples/skills/gsap/mouse-follow.tsx.template`       | Cursor effects        |
